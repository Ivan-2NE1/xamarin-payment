...
namespace QuickDate.Activities.Premium.Adapters
{
    public class CreditAdapter : RecyclerView.Adapter
    {
        ...
        public ObservableCollection<CreditsClass> CreditList = new ObservableCollection<CreditsClass>();
        ...
        public void GetCredits()
        {
            ...
            { 
                ...
                if (option != null)
                {
                    ...
                    CreditList.Add(new CreditsClass { Id = 1, TotalCoins = option.BagOfCreditsAmount, Price =  option.BagOfCreditsPrice, Description = "Bag of Credits", ImageFromResource = Resource.Drawable.Image_coin, Color = "#4caf50" });
                    CreditList.Add(new CreditsClass { Id = 2, TotalCoins = option.BoxOfCreditsAmount , Price = option.BoxOfCreditsPrice , Description = "Box of Credits", ImageFromResource = Resource.Drawable.Image_coins, Color = "#0976f3" });
                    CreditList.Add(new CreditsClass { Id = 3, TotalCoins = option.ChestOfCreditsAmount, Price = option.ChestOfCreditsPrice, Description = "Chest of Credits", ImageFromResource = Resource.Drawable.Image_coinbag, Color = "#9135fa" });
                } 
            }
            catch (Exception e)
            {
