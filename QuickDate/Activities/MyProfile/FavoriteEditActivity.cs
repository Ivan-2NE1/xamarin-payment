...
namespace QuickDate.Activities.MyProfile
{
    ...
    public class FavoriteEditActivity : AppCompatActivity
    {
        ...
        public TextView BackIcon, MusicIcon, DishIcon, SongIcon, HobbyIcon, CityIcon, SportIcon, BookIcon, MovieIcon, ColorIcon, TvShowIcon;
        public EditText EdtMusic, EdtDish, EdtSong, EdtHobby, EdtCity, EdtSport, EdtBook, EdtMovie, EdtColor, EdtTvShow;
