...
namespace QuickDate.Activities.Chat.Adapters
{
    public class StickerAdapter : RecyclerView.Adapter
    {
        ...
        public ObservableCollection<DataFile> StickerList = new ObservableCollection<DataFile>();
            ...
            { 
                if (viewHolder is StickerAdapterViewHolder holder)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        var getImage = IMethods.MultiMedia.GetMediaFrom_Disk(IMethods.IPath.FolderDiskSticker, imageSplit);
        ...
        public override long GetItemId(int position)
        {
            try
            {
                return StickerList[position].Id;
            }
            catch (Exception exception)
            {
                Console.WriteLine(exception);
