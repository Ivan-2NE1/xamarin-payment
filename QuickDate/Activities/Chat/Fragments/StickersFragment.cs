...
namespace QuickDate.Activities.Chat.Fragments
{
    public class StickersFragment : Fragment
    {
        ...
        public LinearLayout LayoutPremium;
        public TextView TxtCountCart;
        public Button BtnGetPremium, BtnBuyCredits;
        public string UserId;
        public MessagesBoxActivity ChatWindow;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            try
            {
                ...
                LayoutPremium.Visibility = UserDetails.IsPro == "0" ? ViewStates.Visible : ViewStates.Gone;
        ...
        private void StickerAdapterOnItemClick(object sender, StickerAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (IMethods.CheckConnectivity())
                {
                    ...
                    MessageController.SendMessageTask(MessagesBoxActivity.Userid, "", stickerUrl?.Id.ToString(), "",time2, ChatWindow?.UserInfoData).ConfigureAwait(false);
                }
                else
                {
