...
namespace QuickDate.Activities.SettingsUser.General
{
    ...
    public class SocialLinksActivity : AppCompatActivity
    {
        ...
        public TextView BackIcon, FacebookIcon, TwitterIcon, GooglePlusIcon, InstagramIcon, LinkedInIcon, WebsiteIcon;
        public EditText EdtFacebook, EdtTwitter, EdtGooglePlus, EdtInstagram, EdtLinkedIn, EdtWebsite;
