...
namespace QuickDate.Activities.SettingsUser
{
    ...
    public class AboutAppActivity : AppCompatActivity
    {
        ...
        public TextView TxtAppName, TxtPackageName, TxtCountVersion;
        public TextView IconVersion, IconChangelog, IconRateApp, IconTerms, IconPrivacy, IconAbout;
        public LinearLayout LayoutChangelog, LayoutRate, LayoutTerms, LayoutPrivacy, LayoutAbout;
