...
namespace QuickDate.Activities.InviteFriends.Adapters
{
    public class InviteContactAdapter : RecyclerView.Adapter
    {
        ...
        public ObservableCollection<IMethods.PhoneContactManager.UserContact> UsersPhoneContacts = new ObservableCollection<IMethods.PhoneContactManager.UserContact>();
        ...
        public void Initialize(InviteContactAdapterViewHolder holder, IMethods.PhoneContactManager.UserContact users)
        {
            try
            {
                ...
                string name = IMethods.Fun_String.DecodeString(users.UserDisplayName);
        ...
        public override int ItemCount
        {
            get
            {
                if (UsersPhoneContacts != null)
                {
                    return UsersPhoneContacts.Count;
                }
                else
                {
                    return 0;
