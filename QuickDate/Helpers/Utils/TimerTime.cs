    ...
    public class TimerTime
    {
        ...
        public string CheckCountTime(int time)
        {
            try
            {
                ...
                var timeBoostSeconds = IMethods.Time.ConvertMinutesToSeconds(Convert.ToDouble(timeBoost));
                ...
                {
                    minutes = IMethods.Time.ConvertMillisecondsToMinutes(Convert.ToDouble(time));
                    seconds = IMethods.Time.ConvertMillisecondsToSeconds(Convert.ToDouble(time));
                }
                else
                {
                    DateTime date = IMethods.Time.UnixTimeStampToDateTime(time);
